...
public class HardikAssignment {
	...
	public static void main(String[] args) {
		...
		if (name == "") {
			...
			System.out.println("Developed by Hardik Pachange, 1132220504, RollNo:- 32");
		} else {
			System.out.println("Thank you " + name + " for using our system ");
			System.out.println("Developed by Hardik Pachange, 1132220504, RollNo:- 32");
		}
	}
